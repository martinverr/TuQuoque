...
public class Miner extends NPC{
    public Miner(World world, Vector2 coords, AssetManager assetManager) {
        super(world, 0.5f, 0.6f, coords);

        setNPCname("Minatore");
        setConversationConfigPath("NPC/Miner/dialogue_default.json");
        setNpcAnimation(new OnlyIdleAnimation(assetManager, "NPC/Miner/idle.atlas"));
    }
