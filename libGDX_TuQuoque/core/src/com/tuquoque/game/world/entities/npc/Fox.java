...
public class Fox extends NPC{
    public Fox(World world, Vector2 coords, AssetManager assetManager) {
        super(world, 0.5f, 0.5f, coords);

        setNPCname("Volpe");
        setConversationConfigPath("NPC/fox/dialogue_default.json");
        setNpcAnimation(new OnlyIdleAnimation(assetManager, "NPC/fox/idle.atlas"));
    }
